...
<BODY>
<FORM id=form1 name=form1 action="${ pageContext.request.contextPath }/user/login" method=post target="_parent">
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150><INPUT id=txtName 
                  style="WIDTH: 130px" name="user.name"></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><INPUT id=txtPwd style="WIDTH: 130px" 
                  type=password name="user.password"></TD>
